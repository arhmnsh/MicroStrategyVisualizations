(function () { 
    ...
    mstrmojo.plugins.ARLineChart.ARLineChart = mstrmojo.declare(
        mstrmojo.CustomVisBase,
        null,
        {
            scriptClass: "mstrmojo.plugins.ARLineChart.ARLineChart",
            cssClass: "arlinechart",
            errorMessage: "Either there is not enough data to display the visualization or the visualization configuration is incomplete.",
            errorDetails: "This visualization requires one or more attributes and one metric.",
            externalLibraries: [{url:"file://../plugins/ARLineChart/javascript/mojo/js/source/highcharts.js"},{url:"file://../plugins/ARLineChart/javascript/mojo/js/source/highcharts-more.js"}],
